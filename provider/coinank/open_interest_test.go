...
func TestOpenInterestAll(t *testing.T) {
	...
	if resp[0].ExchangeName != "ALL" {
		t.Error("exchange name is not ALL")
	}
...
func TestOpenInterestChartV2(t *testing.T) {
	client := NewCoinankClient(coinank_enum.MainUrl, requireTestApikey(t))
	resp, err := client.OpenInterestChartV2(
		context.TODO(),
		"BTC",
...
func TestOpenInterestSymbolChart(t *testing.T) {
	client := NewCoinankClient(coinank_enum.MainUrl, requireTestApikey(t))
	resp, err := client.OpenInterestSymbolChart(
		context.TODO(),
		coinank_enum.Binance,
		"BTCUSDT",
		coinank_enum.Hour1,
...
func TestOpenInterestKline(t *testing.T) {
	client := NewCoinankClient(coinank_enum.MainUrl, requireTestApikey(t))
	resp, err := client.OpenInterestKline(
		context.TODO(),
		coinank_enum.Binance,
		"BTCUSDT",
		coinank_enum.Hour1,
...
func TestOpenInterestAggKline(t *testing.T) {
	client := NewCoinankClient(coinank_enum.MainUrl, requireTestApikey(t))
	resp, err := client.OpenInterestAggKline(
		context.TODO(),
		"BTC",
		coinank_enum.Hour1,
		time.Now().UnixMilli(),
...
func TestInstrumentsOiVsMc(t *testing.T) {
	client := NewCoinankClient(coinank_enum.MainUrl, requireTestApikey(t))
	resp, err := client.InstrumentsOiVsMc(
		context.TODO(),
		"BTC",
		coinank_enum.Hour1,
		time.Now().UnixMilli(),
